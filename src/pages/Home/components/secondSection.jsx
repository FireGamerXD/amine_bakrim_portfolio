...
import js from '../../../utils/imgs/js.png'
import tailwind from '../../../utils/imgs/tailwindlogo.png'
import react from '../../../utils/imgs/REACT.png'
import laravel from '../../../utils/imgs/laravel.png'
import sass from '../../../utils/imgs/sass.png'
import BootStrap from '../../../utils/imgs/bootstrap.png'
import css from '../../../utils/imgs/csslogo.png'
...
Passionate web developer skilled in crafting interactive, user-friendly websites and robust applications that exceed expectations. Let's create something extraordinary together!
            </p>
        </div>
    </div>
</div>
<div className="text flex justify-center">
  <h1 className='text-center text-white p-4 rounded-full text-6xl border-t mt-8 bg-primary-color'>My Skills</h1>
</div>
{/* cards1 */}
  <div class="p-24 flex flex-wrap items-center justify-center">
  <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none" >
        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
        <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white"/>
      </svg>
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-32 h-40 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40 p-8" src={react} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2023-2024</span>
        <div class="flex justify-between">
          <span class="block font-semibold text-xl">REACT</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        ...
        <img class="relative w-40 p-8" src={css} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2022-2024</span>
        <div class="flex justify-between">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40 p-8" src={sass} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2022-2024</span>
        <div class="flex justify-between">
          <span class="block font-semibold text-xl">Sass</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40 p-8" src={laravel} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2022-2024</span>
        <div class="flex justify-between">
          <span class="block font-semibold text-xl">Laravel</span>
        </div>
      </div>
    </div>
...
<div class="p-24 flex flex-wrap items-center justify-center">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40" src={js} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2021-2024</span>
        <div class="flex justify-between">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40" src={tailwind} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2022-2024</span>
        <div class="flex justify-between">
          <span class="block font-semibold text-xl">tailwind</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-primary-color rounded-lg max-w-xs shadow-lg">
      ...
      <div class="relative pt-10 px-10 flex items-center justify-center">
        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" ></div>
        <img class="relative w-40 " src={BootStrap} alt=""/>
      </div>
      <div class="relative text-white px-6 pb-6 mt-6">
        <span class="block opacity-75 -mb-1">2021-2024</span>
        <div class="flex justify-between">
          <span class="block font-semibold text-xl">BootStrap</span>
        </div>
      </div>
    </div>
  ...
  <div class="grid gap-8 row-gap-10 lg:grid-cols-2">
    <div class="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 class="mb-3 text-xl font-bold leading-5">Social Media</h6>
      <p class="mb-3 text-sm text-gray-900">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod quae, voluptates laboriosam minus, veritatis quis ea consequuntur in atque .
      </p>
      <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-primary-color hover:text-second-color">Learn more</a>
    </div>
    <div class="max-w-md sm:mx-auto sm:text-center">
      <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50 sm:mx-auto sm:w-24 sm:h-24">
        <svg class="w-12 h-12 text-deep-purple-accent-400 sm:w-16 sm:h-16" stroke="currentColor" viewBox="0 0 52 52">
      ...
      <h6 class="mb-3 text-xl font-bold leading-5">E-Commerce</h6>
      <p class="mb-3 text-sm text-gray-900">
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod quae, voluptates laboriosam minus, veritatis quis ea consequuntur in atque .
      </p>
      <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-primary-color hover:text-second-color">Learn more</a>
    ...
    <div class="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 class="mb-3 text-xl font-bold leading-5">Doctor website</h6>
      <p class="mb-3 text-sm text-gray-900">
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod quae, voluptates laboriosam minus, veritatis quis ea consequuntur in atque .
      </p>
      <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-primary-color hover:text-second-color">Learn more</a>
    ...
    <div class="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 class="mb-3 text-xl font-bold leading-5">Others</h6>
      <p class="mb-3 text-sm text-gray-900">
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod quae, voluptates laboriosam minus, veritatis quis ea consequuntur in atque .
      </p>
      <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-primary-color hover:text-second-color">Learn more</a>
...
<div class="relative items-top justify-center min-h-[80vh] bg-white sm:items-center sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        <h1 class="p-4 text-4xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight">
                            Get in touch
                        </h1>
